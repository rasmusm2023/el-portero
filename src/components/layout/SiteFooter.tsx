        ...
        <div className="mx-auto w-full max-w-[min(100%,112rem)] px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="min-w-0 lg:max-w-md">
              ...
              <div className="mt-5 flex gap-3 text-sm leading-relaxed text-paper/85">
                <MapPin
                ...
                <div className="min-w-0 space-y-3">
                  ...
                  <a
                    href={bookingTelHref()}
                    className="block font-medium text-paper transition-colors hover:text-paper/90"
                  >
                    {BOOKING_PHONE_DISPLAY}
                  </a>
                  <a
                    href={contactMailtoHref()}
                    className="block break-all font-medium text-paper underline decoration-paper/35 underline-offset-[0.2em] transition-colors hover:decoration-paper/80"
                  >
                    {CONTACT_EMAIL}
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="inline-block text-sm font-medium tracking-wide text-paper/80 underline decoration-paper/30 underline-offset-[0.25em] transition-colors hover:text-paper hover:decoration-paper/70"
                  >
