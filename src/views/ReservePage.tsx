  ...
  return (
    <div className="mx-auto w-full max-w-[var(--container-max)] px-4 pb-20 pt-10 sm:px-6 sm:pb-24 sm:pt-12 lg:px-8 lg:pt-16">
      ...
      <section
        ...
        className="mx-auto mt-12 max-w-2xl border border-ink/12 bg-paper-dark/25 px-5 py-6 sm:mt-14 sm:px-7 sm:py-7"
      >
        <h2
          id="reserve-alt-heading"
          className="text-center font-sans text-xs font-semibold tracking-[0.22em] text-ink/80 uppercase"
        >
          {t(locale, "page.reserve.altBookingTitle")}
        </h2>
        <p className="mt-3 text-center font-sans text-sm leading-relaxed text-ink-muted">
          {t(locale, "page.reserve.altBookingBody")}
        </p>
        <p className="mt-4 text-center font-mono text-sm text-ink">{BOOKING_PHONE_DISPLAY}</p>
        <div className="mt-5 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
          <a
            href={bookingTelHref()}
            className="inline-flex min-h-11 min-w-[8.5rem] flex-1 items-center justify-center gap-2 rounded-none border-2 border-ink/35 bg-white px-4 py-2.5 text-xs font-bold tracking-[0.18em] text-ink uppercase shadow-sm ring-1 ring-ink/8 transition-[border-color,background-color] hover:border-ink hover:bg-ink/4 sm:flex-initial sm:text-sm sm:tracking-[0.2em]"
          ...
          <a
            ...
            className="inline-flex min-h-11 min-w-[8.5rem] flex-1 items-center justify-center gap-2 rounded-none border-2 border-[#128C7E]/50 bg-white px-4 py-2.5 text-xs font-bold tracking-[0.18em] text-[#075E54] uppercase shadow-sm ring-1 ring-[#128C7E]/15 transition-[border-color,background-color] hover:border-[#128C7E] hover:bg-[#128C7E]/6 sm:flex-initial sm:text-sm sm:tracking-[0.2em]"
